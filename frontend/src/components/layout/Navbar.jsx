...
const Navbar = ({ onOpenSidebar }) => {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/80 px-3 py-3 backdrop-blur dark:border-slate-800 dark:bg-slate-950/80 sm:px-4 lg:px-6">
      <div className="flex flex-wrap items-start justify-between gap-3 sm:items-center">
        ...
        <div className="flex w-full flex-wrap items-center justify-end gap-2 sm:w-auto sm:gap-3">
          <button
            type="button"
            onClick={openChat}
            className="relative inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-100 sm:h-11 sm:w-11"
          >
      ...
      <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between lg:mt-2">
        ...
        <div className="flex min-w-0 w-full items-center justify-between gap-2 sm:hidden">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2 rounded-full bg-slate-100 px-3 py-2 dark:bg-slate-800">
