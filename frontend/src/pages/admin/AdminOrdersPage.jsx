      ...
      {orders.map((order) => (
        <div key={order._id} className="glass-panel p-4 sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="inline-flex rounded-full bg-brand-50 px-4 py-2 text-sm font-semibold text-brand-700 dark:bg-brand-900/40 dark:text-brand-100">
          ...
          <div className="mt-4 grid grid-cols-2 gap-2 lg:flex lg:flex-wrap lg:items-center lg:gap-3">
